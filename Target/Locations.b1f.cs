...
namespace Target
{
    [FormAttribute("Target.Locations", "Locations.b1f")]
    class Locations : UserFormBase
    {
        public Locations()
        {
        }
        ...
        public override void OnInitializeComponent()
        {
            ...
            this.StaticText3 = ((SAPbouiCOM.StaticText)(this.GetItem("stLocTpN").Specific));
            ...
            this.StaticText5 = ((SAPbouiCOM.StaticText)(this.GetItem("stPNam").Specific));
            this.EditText3 = ((SAPbouiCOM.EditText)(this.GetItem("etPNam").Specific));

...
namespace Target
{
    [FormAttribute("Target.LocationType", "LocationType.b1f")]
    class LocationType : UserFormBase
    {
        public LocationType()
        {
        }
        ...
        {
            this.StaticText0 = ((SAPbouiCOM.StaticText)(this.GetItem("stName").Specific));
            this.EditText0 = ((SAPbouiCOM.EditText)(this.GetItem("etName").Specific));
            this.StaticText1 = ((SAPbouiCOM.StaticText)(this.GetItem("stDesg").Specific));
            this.EditText1 = ((SAPbouiCOM.EditText)(this.GetItem("etDesg").Specific));
            this.ComboBox0 = ((SAPbouiCOM.ComboBox)(this.GetItem("cbPart").Specific));
            this.ComboBox0.ComboSelectAfter += new SAPbouiCOM._IComboBoxEvents_ComboSelectAfterEventHandler(this.ComboBox0_ComboSelectAfter);
            this.StaticText2 = ((SAPbouiCOM.StaticText)(this.GetItem("stPart").Specific));
            ...
            this.StaticText3 = ((SAPbouiCOM.StaticText)(this.GetItem("stCode").Specific));
            this.EditText2 = ((SAPbouiCOM.EditText)(this.GetItem("etCode").Specific));
            ...
            this.EditText4 = ((SAPbouiCOM.EditText)(this.GetItem("etPrtNam").Specific));

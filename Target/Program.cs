    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                //MyMenu.AddMenuItems();
                MyMenu.BasicStart();
                SAPItemMaster Item = new SAPItemMaster();
                SAPItemGroup ItemGroup = new SAPItemGroup();
                SAPCostCenter CostCenter = new SAPCostCenter();
                SAPSalesOrder SalesOrder = new SAPSalesOrder();
